...
const Header: React.FC = () => {
    return(
        <section className="bg-gradient-to-r from-blue-400 via-white-900 to-blue-300 py-6 px-8 shadow-md ">
            <div className="max-w-8xl flex justify-between items-center ml-20 mr-20">
                ...
                <div className="flex items-center">
                    ...
                    <div className="flex gap-1 items-center border-l border-blue-300 pl-6">
                        <Link href='https://x.com/vaishakh_CS' className="p-2 hover:bg-blue-200 transition-all duration-300">
                            <Image src={'x.svg'} alt="X/Twitter" width={20} height={20} className="filter brightness-0 saturate-100 opacity-70 hover:opacity-100"/>
                        </Link>
                        <Link href='https://github.com/CSVaishakh' className="p-2 hover:bg-blue-200 transition-all duration-300">
                        ...
                        <Link href='https://linkedin.com/in/csvaishakh' className="p-2 hover:bg-blue-200 transition-all duration-300">
