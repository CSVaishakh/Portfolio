...
const Header: React.FC = () => {
    return(
        <section className="fixed top-4 left-1/2 transform -translate-x-1/2 z-50 flex gap-6 bg-gradient-to-r from-blue-100 via-white to-blue-100 backdrop-blur-md rounded-2xl shadow-xl px-8 py-4 animate-float-bar">
