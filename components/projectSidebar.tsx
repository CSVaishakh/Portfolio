...
const Sidebar: React.FC = () => {
    return(
        <section className="fixed top-1/2 left-6 -translate-y-1/2 z-50 flex flex-col gap-6 bg-gradient-to-b from-blue-100 via-white to-blue-100 backdrop-blur-md rounded-2xl shadow-xl px-4 py-8 animate-float-bar">
